$(document).ready(function(){
	...
	function Validate(){};
  		...
  		Validate.prototype = { /* PROTOTYPE --> permite heredar, es palabra reservada*/
  			email : function(email){
      			var pattern = new RegExp(/^[\w-]+(\.[\w-]+)*@([\w-]+\.)+[a-zA-Z]+$/); /* Expresion regular --> reglas para validar la informacion, esto es un lenguaje complicado*/
    	...
    	userid : function(uid){
		  ...
		  $('#buttons #info').remove();
		   ...
		   $('.button').bind('click', function(event){ /* bind se comporta mejor para los moviles , esto se desencadena en el boton "enviar" */
